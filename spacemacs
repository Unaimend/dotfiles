...
values."
  (setq-default
   ...
   dotspacemacs-excluded-packages '(google-style-c)
...
you should place your code here."
  ...
  (spacemacs/set-leader-keys "w[" 'sp-wrap-square)
  )
